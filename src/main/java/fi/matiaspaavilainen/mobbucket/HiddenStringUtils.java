...
public class HiddenStringUtils {
    ...
    private static final String SEQUENCE_HEADER = "" + ChatColor.RESET + ChatColor.ITALIC + ChatColor.RESET + ChatColor.UNDERLINE + ChatColor.RESET;
    private static final String SEQUENCE_FOOTER = "" + ChatColor.RESET + ChatColor.UNDERLINE + ChatColor.RESET + ChatColor.ITALIC + ChatColor.RESET;
